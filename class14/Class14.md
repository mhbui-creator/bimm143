...
- [Background](#background)
  ...
  - [Section 1: Setup DESeq Object](#section-1-setup-deseq-object)
...
```
    ...
    Info: Working in directory /Users/melissabui/BIMM143/bimm143/class14
...
The pathway with the most significant Entities p-value is the Cell Cycle
pathway p = 2.63 × 10⁻⁵, followed closely by Cell Cycle, Mitotic, p =
2.78 × 10⁻⁵. Overall, the top Reactome pathways are consistent with the
earlier KEGG analysis if KEGG also identified pathways related to the
cell cycle, DNA replication, or mitosis, supporting the biological
reliability of the results across databases. Differences between
Reactome and KEGG pathway rankings and significance values may still
occur since the two databases use different statistical approaches and
pathway definitions.
